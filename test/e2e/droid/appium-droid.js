...
var wd = require("wd"),
    serverConfigs = require('../ios/appium-servers' ),
    chai = require("chai" ),
    ...
    Q = require('q' ),
    HomePage = require ('./home-droid-appage' ),//require ('./home-ios-appage' ),
    MainPage = require ('./droid-appage' ),//require ('./main-ios-appage' ),
    ContentPage = require ('./droid-appage' ),//require ('./content-ios-appage' ),
    MenuPage = require ('./menu-droid-appage' ),//require ('./menu-ios-appage' ),
    SLEEP_TIME = require ('./droid-appage' );//process.env.APPIUM_PAUSE || 1000;
...
describe("appium android", function () {
    ...
    before(function () {
        ...
        if ( typeof this.browser === 'object' ) { // configured from grunt appium
            ...
            return driver.init( desired ).then( function () {
                return ( new HomePage(driver).waitForTextElement() );
            });
        }
    });
    beforeEach( function () {
...
//        return driver.sleep( SLEEP_TIME*2 ).quit();
    ...
    afterEach(function () {
        takeScreenshot('droid_' + new Date().getTime() );
        // is this called after after at the end?
//        return menu.goHome();
    });
    // test of page object
    it('should allow you to click on get Started Button' , function () {
        return expect ( home.tapButton() ).to.eventually.not.be.rejected;
    });
